...
const User = () => {
    ...
    return (
        <>
            <main className="container mx-auto p-4 w-full flex flex-col items-center">
                ...
                <span className="mt-2 flex items-center gap-1 rounded-full text-gray-700 px-2.5 font-bold py-0.5 text-xs bg-gray-400">
                    <LuUserPlus2 size={15} />
                    Conectar
                </span>
                ...
                <section className="mt-4 grid grid-cols-1 gap-2 md:grid-cols-2 max-w-5xl w-full">
                    ...
                    <div className="flex flex-col rounded-lg p-2 gap-2">
                        ...
                        <div className="flex items-start gap-4 p-2 dark:bg-gray-50 bg-gray-200 rounded-lg">
                            ...
                            <div>
                                <h3 className="text-lg font-medium text-gray-900">09/2024 - Atual</h3>
                                <p className="text-gray-700 font-extrabold">Full Stack</p>
                                <p className="text-gray-700">Reference site about Lorem Ipsum</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4 p-2 dark:bg-gray-50 bg-gray-200 rounded-lg">
                            ...
                            <div>
                                <h3 className="text-lg font-medium text-gray-900">08/2023 - 08/2024</h3>
                                <p className="text-gray-700 font-extrabold">Frontend Developer</p>
                                <p className="text-gray-700">Another Company</p>
                            </div>
                        </div>
                    </div>
                </section>
