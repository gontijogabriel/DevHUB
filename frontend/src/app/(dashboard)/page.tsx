...
import LogginButton from '@/components/Buttons/LogginButton';
                        ...
                        <div className="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
                            ...
                            <div className="mt-8 flex justify-center">
                                <div className='flex w-max gap-2 items-center cursor-pointer transition hover:text-gray-700/75 dark:hover:text-gray-500 text-gray-900 bg-gray-300 p-2 rounded-lg'>
                                    ...
                                    <LogginButton action={login} text='Entre com GitHub!' style='' />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section>
                    <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
                        ...
                        <dl className="mt-6 grid grid-cols-1 gap-4 sm:mt-8 sm:grid-cols-2 lg:grid-cols-4">
                            <div className="flex flex-col rounded-lg dark:bg-gray-50 bg-gray-200 px-4 py-8 text-center">
                            ...
                            <div className="flex flex-col rounded-lg dark:bg-gray-50 bg-gray-200 px-4 py-8 text-center">
                                ...
                                <dd className="text-4xl font-extrabold text-gray-900 md:text-5xl">24</dd>
                            </div>

                            <div className="flex flex-col rounded-lg dark:bg-gray-50 bg-gray-200 px-4 py-8 text-center">
                                <dt className="order-last text-lg font-medium text-gray-500">Total Addons</dt>

                                <dd className="text-4xl font-extrabold text-gray-900 md:text-5xl">86</dd>
                            </div>

                            <div className="flex flex-col rounded-lg dark:bg-gray-50 bg-gray-200 px-4 py-8 text-center">
                                <dt className="order-last text-lg font-medium text-gray-500">Downloads</dt>

                                <dd className="text-4xl font-extrabold text-gray-900 md:text-5xl">86k</dd>
                            </div>
                        </dl>
                    </div>
                </section>
